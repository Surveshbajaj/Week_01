import java.util.Scanner;
	...
	public class RoundOfAthlete{
            public int NumberOfRound(double side1 , double side2 , double side3 , int distance){
		...
		public static void main(String args[]){
			...
			RoundOfAthlete obj = new RoundOfAthlete();
 
		int round = obj.NumberOfRound(side1 , side2, side3 , distance);
